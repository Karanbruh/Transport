                    ...
                    <div className="row align-items-center m-0">
                        <div className="col-lg-6">
                            <div className="box-login-left">
                                ...
                                <div className="box-btn-signin mt-55"><Link className="btn btn-signin mb-10 wow animate__animated animate__fadeIn" href="#"><img src="/assets/imgs/page/login/Google.svg" alt="Durga Shipping" />Sign up with Google</Link><Link className="btn btn-signin wow animate__animated animate__fadeIn" href="#"><img src="/assets/imgs/page/login/apple.svg" alt="Durga Shipping" />Sign up with Apple ID</Link></div>
