                            ...
                            <div className="box-pageheader-1 box-pageheader-services text-start pb-30"><span className="btn btn-tag wow animate__animated animate__fadeIn">Our Services</span>
                                ...
                                <div className="row align-items-center">
                                    <div className="col-lg-6 mb-30">
                                        <div className="box-author"><Link className="wow animate__animated animate__fadeIn" href="#"><img src="/assets/imgs/page/homepage1/author.png" alt="Durga Shipping" /></Link>
                                            <div className="author-info wow animate__animated animate__fadeIn"><Link href="#"><span className="font-xl-bold color-brand-2 author-name">Courtney Henry</span></Link><span className="font-sm color-grey-500 department">Bank of America</span></div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mb-30">
                                        <div className="d-flex justify-content-start justify-content-lg-end wow animate__animated animate__fadeIn"><span className="font-xs color-grey-700 mr-30">29 May 2022</span><span className="font-xs color-grey-700 mr-30">125 Views</span><span className="font-xs color-grey-700 mr-15">Share</span>
                                            <div className="box-socials wow animate__animated animate__fadeIn"><Link className="mr-5" href="#">
                                                ...
                                                </svg></Link><Link className="mr-5" href="#">
                ...
                <div className="section">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-xl-10"><img className="w-100 wow animate__animated animate__fadeIn" src="/assets/imgs/page/blog-single/img.png" alt="Durga Shipping" /></div>
                        </div>
                    </div>
                </div>
                <section className="section mt-50">
                    <div className="container">
                        <div className="content-detail"><strong className="font-md-bold color-grey-900 mb-25 d-block wow animate__animated animate__fadeIn">Sea freight forwarding, also known as ocean freight forwarding, is a critical aspect of the global supply chain. It refers to the transportation of goods via cargo ships or vessels from one port to another. This mode of transportation is preferred by many businesses due to its cost-effectiveness, reliability, and ability to transport large quantities of goods. In this article, we will discuss the basics of sea freight forwarding, including its benefits, modes of transportation, and key players.</strong>
                            ...
                            <p className="wow animate__animated animate__fadeIn"><img src="/assets/imgs/page/service-detail/img3.png" alt="Durga Shipping" /></p>
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-7">
                                    <p className="wow animate__animated animate__fadeIn">Sea freight forwarding offers several benefits to businesses that use it to transport their goods. Some of the benefits include:</p>
                                    <p className="wow animate__animated animate__fadeIn">Cost-Effectiveness: Sea freight forwarding is one of the most cost-effective modes of transportation, especially for businesses that require the transportation of large quantities of goods. This is because cargo ships can transport large volumes of goods at a lower cost compared to other modes of transportation.</p>
                                    <p className="wow animate__animated animate__fadeIn">Sea freight forwarding is a reliable mode of transportation since it is not affected by traffic or weather conditions. Additionally, cargo ships are designed to withstand harsh weather conditions, which reduces the risk of damage or loss of goods.</p>
                                </div>
                                <div className="col-lg-5"><img className="wow animate__animated animate__fadeIn" src="/assets/imgs/page/service-detail/img4.png" alt="Durga Shipping" /></div>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-8 col-md-8">
                                <h2 className="title-favicon mb-20 wow animate__animated animate__fadeIn">Recent Post</h2>
                            ...
                            <div className="col-lg-4 col-md-4 text-end">
                                <div className="box-button-sliders">
                                    <div className="swiper-button-prev swiper-button-prev-style-1 swiper-button-prev-customers">
                                        <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
                                        </svg>
                                    </div>
                                    <div className="swiper-button-next swiper-button-next-style-1 swiper-button-next-customers">
                                        <svg fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
